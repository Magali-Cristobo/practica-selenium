  ...
  <div class="container wrapper">
    <form class="form">
      ...
      <div class="form-group">
        ...
        <input type="text" class="nombre form-control" placeholder="Name" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="Mensaje form-control" placeholder="Mensaje"></textarea>
      </div>
      ...
      <button class="btn enviar" type="submit" onclick=>Enviar</button>
    </form>
  </div>
